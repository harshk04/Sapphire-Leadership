...
export const metadata: Metadata = {
  title: 'Consultation Bookings Admin',
  description: 'Review and manage Sapphire Leadership consultation bookings.',
};
  ...
  return (
    <main className="min-h-screen bg-surface py-12 text-ink">
      <div className="mx-auto w-full max-w-7xl px-5 md:px-10">
        <div className="flex flex-col gap-4 rounded-[28px] border border-surface-variant/40 bg-white/75 p-6 shadow-soft backdrop-blur-xl md:p-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-[14px] leading-7 text-ink-muted">
                Review free consultation requests, confirm availability, and keep the advisory pipeline organized.
              </p>
            </div>
            <Link
              href="/consultation"
